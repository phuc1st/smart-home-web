        ...
        <div class="main-content fl-right" style="width: 100%;">
            <div class="section" id="detail-blog-wp">
                <div class="section-head clearfix">
                    <h3 class="section-title">SMART HOME STORE - Cửa hàng đồ điện tử uy tín hàng đầu Việt Nam </h3>
                </div>
                <div class="section-detail">
                    <span class="create-date">22/05/2022</span>
                    <div class="detail">
                        <p><strong>SMART HOME STORE là cửa hàng có hơn kinh nghiệm 10 năm trong lĩnh vực đồ điện tử bao gồm máy tính, lap top, điện thoại, di động tại Hà Nội. Cùng với đội ngũ nhân viên chuyên nghiệp, luôn đặt trải nghiệm của khách hàng lên hàng đầu sẵn sàng tư vấn để bạn có thể chọn được một sản phẩm phù hợp nhất.</strong></p>
                        <p> Hiểu được tâm lí khách hàng khi mua đồ điện tử, SMART HOME luôn nỗ lực từng ngày để hoàn thiện :
                        ...
                        <p>
                            ...
                            <br>- Ngoài ra, tất cả khách hàng khi đến với SMART HOME đều sẽ được tận hưởng các gói dịch vụ hậu mãi sau bán hàng như vệ sinh máy, cài phần mềm, cân màu màn hình… hoàn toàn miễn phí.
                            <br>- Đối với khách hàng ở xa không thể trải nghiệm được máy một cách trọn vẹn, SMART HOME đã có một đỗi ngũ chuyên viên tư vấn 24/7, tận tình cặn kẽ tư vấn máy.
                        ...
                        <p style="text-align: center;">
                            <img src="public/images/intro.png" alt="">
                        </p>
